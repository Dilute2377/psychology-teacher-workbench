...
const consultationStore = useConsultationStore(); const termStore = useTermStore(); const workbench = useWorkbenchStore(); const router = useRouter(); const students = ref<Student[]>([]); const crisisConfig = useCrisisConfigStore()
...
const riskBadge = (value: string | null | undefined) => crisisConfig.getStudentWarningBadge(value)
