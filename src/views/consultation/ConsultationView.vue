...
const riskLabels: Record<string, string> = { normal: '正常', attention: '关注', warning: '重点关注', crisis: '危机预警' }
const riskClasses: Record<string, string> = { normal: 'bg-emerald-50 text-emerald-700', attention: 'bg-amber-50 text-amber-700', warning: 'bg-orange-50 text-orange-700', crisis: 'bg-rose-50 text-rose-700' }
